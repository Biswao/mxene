...
const HeroSection = () => {
  ...
  <div className="container position-absolute top-50 start-50 translate-middle text-center text-white" data-aos="fade-up" data-aos-delay="500">
    ...
    <h2 style={{ fontSize: '2rem' }} className='text-stroke String1'>Unlocking the Potential of 2D Materials. </h2><br />
    <h2 style={{ fontSize: '1.5rem' }} className='text-stroke String2'>Exploring Innovations in Energy Storage, EMI Shielding, and 
      Water Purification. </h2><br />
    <h4 className='text-stroke String3' style={{fontWeight:'normal'}}>At MXeneTech by Reseapro Labs, we are dedicated to discovering the 
      possibilities within MXenes, MAX Phases, <br />and Graphene—advanced 2D materials that could change the future of energy storage, 
